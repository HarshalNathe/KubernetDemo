...
gulp.task('config', function () {
  ...
  console.log('Application started using ' + env + ' environment');
...
gulp.task('scripts', ['img', 'config'], function () {
...
gulp.task('vet-dev', ['clean'], function () {
  ...
  return gulp
    .src(['!./public/js/services/config.js', './public/js/' + '**/*.js'])
